...
class AuthService:
    ...
    async def register_user(
        ...
        # Send verification email (skip in development if email not configured)
        try:
            ...
            # Skip email in development - auto-verify user
            user = await self.user_repo.update_verification_status(user.id, True)
