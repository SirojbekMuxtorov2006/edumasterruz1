...
import { Linkedin, Twitter, Mail, GraduationCap, Award, Globe, Users } from 'lucide-react';
...
const BoardMembers = () => {
	...
	const members = [
		...
		},
		{
			...
			image: '/photo_2026-04-02_00-43-31.jpg',
			...
			<main className='flex-grow pt-24 pb-16'>
				...
				<section className='bg-gray-900 text-white py-16'>
					<div className='container mx-auto px-4 text-center'>
						...
						<h1 className='text-4xl md:text-5xl font-bold mb-6'>{t('board.title')}</h1>
